...
////      code with live location and test camera across all device
...
// take location from erpnext customr_area_name
...
// after back navigation photo preveiw visible
...
//         // Show photo preview if there's a photo in the latest checkin
//         if (latestCheckin.custom_photo) {
//           setPhotoUri(`${ERP_BASE_URL}${latestCheckin.custom_photo}`);
